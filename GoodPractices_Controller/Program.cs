...
namespace GoodPractices_Controller
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(gradeController.AddPartialGradeToStudent("2018-1", 4.5f , "Math 1", GradeType.FINAL, "351531"));
            Console.WriteLine(gradeController.CalculateFinalGradeToStudent("2018-1", "351531"));
        }
    }
}
